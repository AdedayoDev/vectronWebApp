...
const VehicleProfile = () => {
  ...
  return (
    <main className="w-11/12 mx-auto h-auto flex items-center justify-center ">
      <section
        className="hidden lg:block w-[600px] rounded-xl mx-auto h-auto my-auto md:my-4"
        style={{
        ...
        >
          <div className="p-10 flex flex-col items-start w-full h-full">
            ...
            <div className="flex flex-col justify-between h-screen w-full mt-10">
              <div>
                <p className="font-medium font-inter text-center text-3xl text-white w-[525px] mb-4">
