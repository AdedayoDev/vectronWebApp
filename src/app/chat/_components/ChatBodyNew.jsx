    ...
    return (
        ...
        <div className="flex flex-col bg-[#FFFFFF] p-3  space-y-2 lg:space-y-3 text-black rounded-xl">
          ...
          <svg width="21" height="30" viewBox="0 0 21 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M2.45312 3.74101C3.99359 1.89793 6.70422 0 10.4412 0C12.2543 0 13.6202 0.475995 13.6202 0.475995L7.38024 7.88959H2.95912L2.45312 3.74101Z" fill="#1A73E8"/>
            <path d="M1.03095 15.44C1.03095 15.44 0 13.4211 0 10.4963C0 7.73195 1.0746 5.3156 2.45354 3.74023L7.38417 7.88947L1.03095 15.44Z" fill="#EA4335"/>
            </g>
            <defs>
...
function HealthFeed() {
    return (
        ...
        <div className="flex flex-col bg-[#fc8077] p-3  space-y-2 lg:space-y-3 text-black rounded-xl">
          ...
          <p className="text-white text-xs lg:text-sm font-semibold">Health and Maintenance</p>
          <div className="flex items-center justify-between space-x-1 lg:space-x-3 hover:cursor-pointer my-2">
